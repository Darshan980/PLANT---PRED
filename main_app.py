...
disease_solutions = {
    ...
    'Corn-Common_rust': {
        ...
        'detailed_solution': 'Common rust in cucumber is a fungal disease that causes yellowish to orange pustules on the leaves. Use resistant varieties, apply fungicides such as tebuconazole, and remove any infected leaves to prevent the spread of the disease.'
    }
